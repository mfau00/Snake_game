...
smallfont = pygame.font.SysFont("comicsansms", 20) #moramo def font
...
def randAppleGen():
    ...
    randAppleY = round(random.randrange(0, displayHeight - AppleThickness))
...
def game_intro():
    ...
    while intro:
        ...
        display_msg("Eat as many apples as you can", BLACK, -30, size="small")
        display_msg("The more apples you eat longer you get", BLACK, 10, size="small")
        display_msg("Don't not eat yourself", BLACK, 50, size="small")
...
def display_msg(msg,color,y_displace=0,size="small"): #y_displace pomice od centra
    ...
    #gameDisplay.blit(screen_text, [(displayWidth / 2)-150, displayHeight / 2])
...
def game_loop():
    ...
    while not gameExit:
        ...
        gameDisplay.fill(WHITE) #pozadina

        #pygame.draw.rect(gameDisplay,RED,[randAppleX,randAppleY,AppleThickness,AppleThickness]) #jabuka
        ...
        # pojedemo jabuku i stvaramo novu, i to tako da postojećoj mijenjamo lokaciju. a randApple varijable samo mijenjaju vrijednost
        '''if lead_x == randAppleX and lead_y == randAppleY:
            randAppleX, randAppleY = randAppleGen()
            snakeLength += 1''' #ovo ne moze kad je rijec o vecoj jabuci

        '''if lead_x >= randAppleX and lead_x <= randAppleX+AppleThickness:
            if lead_y >= randAppleY and lead_y <= randAppleY+AppleThickness:
                randAppleX, randAppleY = randAppleGen()
                snakeLength += 1''' #ne radi kad je zmijica veća
